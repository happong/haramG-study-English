...
- taxi — 철자 오류(texi) DAY26에서 3회 반복. 집중 복습 필요.
- wait → waited — DAY26에서 신규 학습 직후 과거형 누락(현재형으로 씀). 반복 확인 필요.
- share → shared — 과거형 누락.
- take a break — "쉬다/휴식을 취하다"는 뜻인데 "타는 것을 멈추다"로 오해함. take의 "타다" 뜻과 혼동 주의.
